...
class `MainActivity-old` : AppCompatActivity() {
...
//                    binding.drawerLayout.closeDrawers()
//                    val intent = Intent(this@`MainActivity-old`, RiwayatActivity::class.java)
//                    this@`MainActivity-old`.startActivity(intent)
//                    true
//                }
//                else -> false
//            }
...
//
//            if (matches.isEmpty()) {
//                Toast.makeText(this@`MainActivity-old`, "Tidak ada data match!", Toast.LENGTH_SHORT).show()
//                return@launch
//            }
//
